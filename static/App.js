    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          "tbody",
          null,
          React.createElement(IssueRow, { issue_id: 0, issue_title: "error in console when clicking add" }),
          React.createElement(IssueRow, { issue_id: 1, issue_title: "missing bottom border on panel" })
        )
      );
    }
  }]);
  ...
  _createClass(IssueAdd, [{
    ...
    value: function render() {
      return React.createElement(
        "div",
        null,
        "This is a placeholder for the issue tracker form."
      );
    }
  }]);
